...
document.addEventListener("DOMContentLoaded", () => {
    ...
    description: `A dumbwaiter lift is a compact freight elevator designed for transporting goods between floors in buildings like hotels, restaurants, hospitals, and homes. It enhances efficiency by reducing manual labor and improving workflow. Made from durable materials like stainless steel, it operates with an electric motor and ensures convenience and safety in various settings.`
  }
    };
